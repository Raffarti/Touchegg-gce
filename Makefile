...
# Generated by qmake (2.01a) (Qt 4.8.3) on: gio ott 18 19:38:20 2012
# Project:  touchegg-gce.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++-64 -o Makefile touchegg-gce.pro
#############################################################################
...
Makefile: touchegg-gce.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++-64 -o Makefile touchegg-gce.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/touchegg-gce1.0.0/ && $(COPY_FILE) --parents gui.h parser.h general.h button.h lists.h editdialog.h memory.h sendkeys.h keylineedit.h keylinguist.h scribe.h newgroupdialog.h dictionary.h langselector.h .tmp/touchegg-gce1.0.0/ && $(COPY_FILE) --parents main.cpp gui.cpp parser.cpp button.cpp lists.cpp editdialog.cpp memory.cpp sendkeys.cpp keylineedit.cpp keylinguist.cpp scribe.cpp newgroupdialog.cpp dictionary.cpp langselector.cpp .tmp/touchegg-gce1.0.0/ && $(COPY_FILE) --parents gui.ui button.ui editdialog.ui sendkeys.ui newgroupdialog.ui .tmp/touchegg-gce1.0.0/ && $(COPY_FILE) --parents Dictionaries/it.ts Dictionaries/en.ts .tmp/touchegg-gce1.0.0/ && (cd `dirname .tmp/touchegg-gce1.0.0` && $(TAR) touchegg-gce1.0.0.tar touchegg-gce1.0.0 && $(COMPRESS) touchegg-gce1.0.0.tar) && $(MOVE) `dirname .tmp/touchegg-gce1.0.0`/touchegg-gce1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/touchegg-gce1.0.0
